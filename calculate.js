...
// let buttonRender = document.getElementById("btnCalcular");
...
export let frete = calcularFrete();
export let valorYuan = valorTotalY();
export let valorReais = valorTotalRS();
export let valorTaxa = valorTaxaTotal();
export let valorDebitado = valorTotalDebitado();
export let precoVenda = calcularPrecoVenda();
