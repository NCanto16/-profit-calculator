...
export function render() {
  ...
  divResults.classList.remove("divResults");
  divResults.classList.add("divResultsRender");

  results.innerHTML = `  
  <div class="renderNome">
...
<div class="divComponents renderPreco">
  <div class="svgTitleComponent">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
<div class="divComponents">
  <div class="svgTitleComponent">
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class="lucide lucide-file-xcorner-icon lucide-file-x-corner"
    >
      <path
...
export function clearResults() {
  divResults.classList.remove("divResultsRender");
